    ...
    <>
      ...
      <div className={variant === 'carousel' ? 'mt-3 md:mt-4 space-y-1' : 'p-5 md:p-8 space-y-3 md:space-y-4'}>
        <div className="flex items-start gap-2">
          <h3
            className={`font-bold tracking-widest uppercase text-[#000000] group-hover:opacity-80 transition-colors leading-tight flex-1 min-w-0 ${
          ...
          <button
            ...
            className="flex-shrink-0 mt-0.5 p-1 text-[#999999] hover:text-[#000000] transition-colors"
