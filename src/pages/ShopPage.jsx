...
const ShopPage = () => {
  ...
  const filteredProducts = ANTWERP_COLLECTION.filter(product =>
    ...
    <div className="font-['Noto_Sans_KR'] bg-black min-h-screen pt-24 pb-20 antialiased relative">
      ...
      <div className="px-8 mb-12">
        <input 
          ...
          className="w-full bg-transparent border-b border-white/10 py-4 text-[12px] font-light tracking-[0.2em] uppercase outline-none focus:border-purple-500 transition-colors placeholder:text-white/5 text-white"
        />
      </div>
      ...
      <div className="px-8 mb-16 flex justify-between items-end">
        <div>
          <h1 className="text-[10px] tracking-[0.5em] uppercase text-purple-500 font-bold mb-3 italic">Selection</h1>
        ...
        <span className="text-[10px] font-light text-white/30 tracking-[0.2em] uppercase mb-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-[1px] gap-y-20 border-t border-white/10">
        {filteredProducts.length > 0 ? (
          ...
          <div className="col-span-full py-40 text-center space-y-4 px-6">
            <p className="text-[12px] font-bold tracking-[0.4em] text-purple-500 uppercase">Archive Empty</p>
            <p className="text-[11px] font-light tracking-[0.2em] text-white/30 uppercase leading-relaxed break-keep">
