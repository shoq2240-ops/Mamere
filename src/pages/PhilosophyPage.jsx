...
const PhilosophyPage = () => {
  return (
    <div className="bg-[#FFFFFF] text-[#000000] min-h-screen pt-32 pb-20 px-6 antialiased">
      <div className="max-w-4xl mx-auto">
        ...
        <motion.div 
          ...
          className="mt-32 h-[1px] bg-gradient-to-r from-[#E5E5E5] to-transparent origin-left"
        />
      </div>
    </div>
  );
